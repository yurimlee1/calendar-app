...
export default function DayView() {
  ...
  return (
    ...
    <div className='grid grid-cols-[auto_auto_1fr] px-4'>
      <div className='w-16 border-r border-gray-300 text-xs'>
        GMT -5
      </div>
    ...
    <ScrollArea className='h-[70vh]'>
      <div className='grid grid-cols-[auto_1fr] p-4'>
        ...
        <div className='relative border-r border-gray-300'>
          {getHours.map((hour, i) => (
            <div key={i} className='relative flex h-16 cursor-pointer flex-col items-center gap-y-2 border-b border-gray-300 hover:bg-gray-100'></div>
          ))}
